...
const BoxIImageNd2 = ({img, logo, title1, title2, titleButton, desc1, desc2, iconCheck}) => {
    return(
        <>
                ...
                <div className="box-image-nd2-content">
                    ...
                    <div className="box-image-nd2-content-container">
                        ...
                        <div className="box-image-nd2-logo-button">
                            <div className="logo">
                                <img src={logo} alt="" className={iconCheck ? 'icon-logon-rectangular' : 'icon-logon-round'}/>
                            </div>
